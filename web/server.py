...
PREVIEW_CONFIG_PATH = os.getenv("PAPERLESS_PREVIEW_CONFIG_PATH", "/data/preview_config.json")
BACKFILL_STATE_PATH = os.getenv("PAPERLESS_BACKFILL_STATE_PATH", "/data/backfill_jobs.json")
PROVIDER_CONFIG_PATH = os.getenv("PAPERLESS_PROVIDER_CONFIG_PATH", "/data/provider_config.json")
MODEL_CONFIG_PATH = os.getenv("PAPERLESS_MODEL_CONFIG_PATH", "/data/model_config.json")
